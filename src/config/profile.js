...
let configuration = {
    profile: {
        ...
        experience: [
            {
                ...
                descriptions: ['FullStack Engineer',
        ...
        skill_interest: [
            ...
            {
                title: 'Hobbies',
                descriptions: ['Novels, Tennis, Video Games, Wasting time on Random Youtube Videos  🤐 ']
            },
        ]
    },
    research: [
