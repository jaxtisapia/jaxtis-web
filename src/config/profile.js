...
let settings = {
  GOOGLE_ANALYTICS_ID: "UA-138288702-1"
};
...
let configuration = {
  profile: {
    ...
    experience: [
      {
        institution: "IT Consortium",
        descriptions: [
          "Backend Engineer",
          "June 2018 - November 2018",
          "One of the largest FinTechs in Africa, processing averagely millions of transactions per day",
          "Built REST APIs for integration with Banks, Insurance Companies and other minor fintech clients, using Java Spring, RabbitMQ, Redis, SQL",
          "Built production-ready USSD Applications for use by over 1 million active users",
          "Testing and deployment of security-tight MicroServices",
          "Maintenance of old projects and collaboration inter/intra team to refactor/extend old projects",
          "Provision of technical support for all baby-authored projects and code base See less"
        ]
      },
      {
        ...
        descriptions: [
          ...
          "Planning, development, testing and deployment (primarily with Heroku) of solutions for both technical and non-technical clients, under mutual and legal conditions",
          "Remote collaborations with other developers, but within the same time zone",
          "Maintenance and support for client projects",
          "Built Mobile Applications using Android Studio (Java)",
          "Crafted standard REST APIs using Node JS, Express JS, Loopback JS, MongoDB",
          "Built visually appealing Web Applications using React JS, Pure HTML, Pure CSS, Vanilla JS",
          "Freelanced(Front-end) on a popular nationwide project for entry-level teachers. Was responsible for building user-facing layouts using pure HTML, CSS and jQuery"
        ]
      },
      {
      ...
      },
      {
        ...
        descriptions: [
          "Opoku Ware Basic School, Kumasi",
          "May 2014 - Nov 2016",
      ...
      },
      {
        ...
        descriptions: [
          "The Gatsby Magazine - Ghana (Available only on Play Store)",
          "Sept 2016 - Sept 2016",
    ...
    skill_interest: [
      ...
      },
      {
        title: "Interests",
        descriptions: [
          "Cyber Security, Programming, Graphic Designing, Robotics"
        ]
      },
      {
        title: "Hobbies",
        descriptions: [
          "Novels, Tennis, Video Games, Wasting time on Random Youtube Videos  🤐 "
        ]
      }
    ]
  },
  research: [
    {
      ...
      link:
        "https://github.com/jaxtisapia/dangers-of-an-exposed-credit-card-processing-api"
    }
  ],
  portfolio: [
    {
    ...
    },
    {
      ...
      description:
        "FunnyOrNot is a joke sharing app. It aims to gather all of the world’s jokes, in whatever format; images, videos, soundbites, and text, into one simple social app. I handled extreme responsibilities of UI/UX design.",
    ...
    },
    {
      ...
      description:
        "ToTo is a joke sharing mobile app. It is exclusively supported only in French",
      link:
        "https://play.google.com/store/apps/details?id=com.yannick.opodame.toto",
      image: totoBanner
    },
    {
      title: "Gatsby Magazine - Mobile App, Web",
      description:
        "The Gatsby Magazine is a unique online magazine that has captured the hearts of students as it contains everything that would prepare you for college academically, socially, morally, etc; including Fashion, Technology, and Lifestyle on campus.",
      link:
    ...
    {
      title:
        "School Management System (Opoku Ware Junior High School, Ghana) - Desktop App",
      description:
        "An Examination Records Management Software that automatically handles rankings and promotions of students. Handles complex management of human resource and students in a simple offline database",
      link: null
    },
    {
      title: "TicketHouse Ghana - UI Redesign",
      description:
        "TicketHouse is a ticket purchasing platform. Know all the events happening around you and when and where they are happening. Events such as concerts, religious, sports, theater and movies in cinemas. THIS PROJECT HAS UNDERGONE VARIOUS SHIFTS IN INTERFACE DESIGN FROM OTHER UI DESIGNERS, AND MIGHT NOT BE A GOOD PORTFOLIO RECORD FOR ME.",
      link:
        "https://play.google.com/store/apps/details?id=com.tickethousegh.app",
  ...
  personalProjects: [
    {
      ...
      image: "",
      descriptions: [
        "I've been gathering data of all matches in different leagues in different countries for the past 5 months - About 15,000 matches",
    ...
    },
    {
      ...
      image: "",
      descriptions: [
        "More spin-and-win bet schemes follow a particular routine, whether revealing it to their clients or otherwise",
    ...
    },
    {
      ...
      image: "",
      descriptions: [
        "Social Media Platform which puts you in scopes of location - You get to meet people within your community and beyond",
    ...
    },
    {
      ...
      image: "",
      descriptions: [
        "Cybersecurity awareness in its early development stages in Africa, should be a key topic of interest to all stakeholders and enthusiast",
