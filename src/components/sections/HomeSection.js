                    ...
                    <div className='uk-flex uk-flex-middle uk-flex-center uk-flex-column'>
                            ...
                            <h1
                                ...
                                <span
                                    className="uk-text-center text-description">
									 Full-Stack Engineer with over 5 years of experience in MeteorJS, ReactJS, ExpressJS and Android (Java).
                                    {' '}Strong TDD Advocate, and a SOLID Evangelist.
								</span>

                                <span className="uk-text-center text-description">
								 Occasionally dabble in Vue JS, LoopBack JS and Java Springboot.
							</span>
                        ...
                        <div className='uk-flex uk-flex-row uk-flex-wrap uk-flex-center uk-margin uk-margin-large-top'>
                            {webConfig.abilityTags.map(function (ability, i) {
                                return <p className='ability-tag uk-flex uk-flex-middle uk-flex-center'
                                          key={i}>{ability}</p>
                            })}
