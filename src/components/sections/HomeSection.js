      ...
      <section className="uk-section">
        <div className="uk-container uk-container-small">
          <div className="uk-flex uk-flex-middle uk-flex-center uk-flex-column">
            <h2 className="name-text-greeting uk-visible@l uk-text-muted">
              Hey there 👋🏿,
            </h2>
            ...
            <div className="uk-flex uk-flex-center uk-flex-column">
              <h1 className="name-text uk-text-small@s uk-flex uk-text-center uk-flex-column">
                ...
                <span className="uk-text-center text-description">
                  Full-Stack Engineer with over 5 years of experience in
                  MeteorJS, ReactJS, ExpressJS and Android (Java). Strong TDD
                  Advocate, and a SOLID Evangelist.
                </span>
                <span className="uk-text-center text-description">
                  Occasionally dabble in Vue JS, LoopBack JS and Java
                  Springboot.
                </span>
              </h1>
            </div>
            ...
            <div className="uk-flex uk-flex-row uk-flex-wrap uk-flex-center uk-margin uk-margin-large-top">
              {webConfig.abilityTags.map(function(ability, i) {
                return (
                  <p
                    className="ability-tag uk-flex uk-flex-middle uk-flex-center"
                    key={i}
                  >
                    {ability}
                  </p>
            ...
            <div className="uk-margin-medium-top">
              <ul className="uk-breadcrumb">
                <li>
                  <Link to={routeList.portfolio}>My Portfolio</Link>
                </li>
                <li>
                  <Link to={routeList.contact}>Make enquiries</Link>
                </li>
                <li>
                  <Link to={routeList.profile}>View my profile</Link>
                </li>
                <li>
                  <Link to={routeList.projects}>
                    Checkout my private projects
                  </Link>
                </li>
              </ul>
            </div>
